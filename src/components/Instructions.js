      ...
      {display ? (
        <section id="rules" className="game-body">
          ...
          <p id="rules-text">
            ...
            of symbols. The length of the pattern and the number of distinct
            symbols depends on the level you select (easy, standard, or hard).
            You will have 10 attempts to guess the pattern. At the end of each
            guess, the computer wisll display two numbers. The first number is
            the number of symbols guessed correctly (not necessarily in the
